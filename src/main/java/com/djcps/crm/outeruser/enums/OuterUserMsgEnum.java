package com.djcps.crm.outeruser.enums;
 ...
 *
 */
public enum OuterUserMsgEnum implements MsgInterface {
	/**
	 * 操作成功
	 */
    ...
    OuterUserMsgEnum(int code, String msg){
        this.code = code;
        this.msg = msg;
    }

    OuterUserMsgEnum(int code){
        this.code = code;
    }
