...
/**
 * Created by ZhangMingHui on 2017/7/18.
 */
public class MultipartFilePam {
    ...
    public MultipartFilePam setFhasPicture(Boolean fhasPicture) {
    ...
    public MultipartFilePam setFadFirstEdit(Boolean fadFirstEdit) {
